...
namespace caffepro {
	class innerproduct_layer : public caffepro_layer {
	public:
		innerproduct_layer(caffepro_context *context, const LayerParameter &param);
		~innerproduct_layer();
	...
	protected:
		...
		boost::shared_ptr<node_blob> bias_multiplier_;
	};
}