...
namespace caffepro {
	...
	class softmax_ohem_split_layer : public caffepro_layer {
	public:
		softmax_ohem_split_layer(caffepro_context *context, const LayerParameter &param);
		~softmax_ohem_split_layer();
