...
namespace caffepro {
	class l1norm_layer : public caffepro_layer {
	public:
		l1norm_layer(caffepro_context *context, const LayerParameter &param);
		~l1norm_layer();
	...
	protected:
		data_type eps_;
		boost::shared_ptr<node_blob> norm1_, sum_multiplier_;
	};
}