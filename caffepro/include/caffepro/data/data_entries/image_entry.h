...
namespace caffepro {
	namespace data_model {
		class image_entry : public data_entry {
		public:
			image_entry(data_provider &provider, const std::string &name);
			virtual ~image_entry();
		...
		protected: 
			...
			void crop_patch_nonuniform(__out cv::Rect &cropRect, __in const cv::Mat &matRawImg, int target_w, int target_h,
