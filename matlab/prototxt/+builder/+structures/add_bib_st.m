function [result, output_name] = add_bib_st(prefix, bottom, bottleneck_outputs, outputs, stride, has_proj, bn_stat)
    assert(nargin >= 4);
    ...
    [r2a, path2a_output] = builder.structures.add_conv_st([prefix, '_branch2a'], bottom, 1, outputs, stride, 0, false, true, true, bn_stat, opt);
    [r2b, path2b_output] = builder.structures.add_bottleneck_st([prefix, '_bib'], path2a_output, bottleneck_outputs, outputs, 1, false, bn_stat);
