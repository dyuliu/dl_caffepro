function [result, output_name] = add_conv_adddiag_st(prefix, bottom, ksize, inputs, outputs, stride, pad, has_bias, has_bn, has_relu, bn_stat, varargin)
    assert(nargin >= 10);
    ...
    result = cat(2, result, builder.layers.add_diag4d_operation([prefix, '_diag'], weight_src_name, weight_src_name, 1, 1));
