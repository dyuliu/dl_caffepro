function [result, output_name] = add_resnet_feaorth_set4_st(prefix, bottom, outputs, stride, has_proj, bn_stat)
    assert(nargin >= 3);
    ...
    [r2a, path2a_output] = builder.structures.add_conv_feaorth_st([prefix, '_branch2a'], bottom, 3, outputs, stride, 1, false, true, true, bn_stat, opt);
    [r2b, path2b_output] = builder.structures.add_conv_feaorth_st([prefix, '_branch2b'], path2a_output, 3, outputs, 1, 1, false, true, false, bn_stat, opt);
