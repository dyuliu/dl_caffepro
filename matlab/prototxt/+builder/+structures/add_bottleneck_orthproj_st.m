function [result, output_name] = add_bottleneck_orthproj_st(prefix, bottom, bottleneck_outputs, outputs, order, stride, has_proj, bn_stat)
    assert(nargin >= 5);
    ...
    [rw_p1, weight_name1] = builder.structures.add_householder_higherorder_st(weight_name1, bottom, [1, 1, outputs, bottleneck_outputs], order, opt);
    ...
    [rw_p2, weight_name2] = builder.structures.add_householder_higherorder_st(weight_name2, bottom, [1, 1, outputs, bottleneck_outputs], order, opt);
    ...
    result = cat(2, result, rw_p1, r2a, r2b, rw_p2, rwt, r2c);
