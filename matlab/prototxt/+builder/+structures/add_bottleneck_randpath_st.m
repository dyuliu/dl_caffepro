function [result, output_name] = add_bottleneck_randpath_st(prefix, bottom, bottleneck_outputs, outputs, stride, has_proj, bn_stat)
    assert(nargin >= 4);
    ...
    [r2b, path2b_output] = builder.structures.add_conv_randpath_st([prefix, '_branch2b'], path2a_output, 3, bottleneck_outputs, bottleneck_outputs, 1, 1, false, true, true, bn_stat, opt);
