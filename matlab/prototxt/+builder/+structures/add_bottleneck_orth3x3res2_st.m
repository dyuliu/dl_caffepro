function [result, output_name] = add_bottleneck_orth3x3res2_st(prefix, bottom, bottleneck_outputs, outputs, order_3x3, stride, has_proj, bn_stat)
    assert(nargin >= 5);
    ...
    norm_name3x3res = [weight_name3x3, '_norm'];
    rw_3x3res_norm = builder.layers.add_layer(norm_name3x3res, 'l2norm', weight_name3x3res, norm_name3x3res);
    weight_name3x3sum = [weight_name3x3, '_sum'];
    rw_3x3sum = builder.layers.add_eltsum(weight_name3x3sum, {weight_name3x3, norm_name3x3res}, weight_name3x3sum, [1, 0.1]);
    ...
    result = cat(2, result, r2a, rw_3x3, rw_3x3res, rw_3x3res_norm, rw_3x3sum, r2b, r2c);
